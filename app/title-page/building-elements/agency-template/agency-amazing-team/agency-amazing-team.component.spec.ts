import { AgencyAmazingTeam } from './agency-amazing-team.component';
...
describe('AgencyAmazingTeam', function () {
  let de: DebugElement;
  let comp: AgencyAmazingTeam;
  let fixture: ComponentFixture<AgencyAmazingTeam>;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     imports:[
            ...
            ReactiveFormsModule,
            HttpModule],
      declarations: [AgencyAmazingTeam,ContentEditOptionNav,ViewUploadedImages,Base64UploadComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AgencyAmazingTeam);
