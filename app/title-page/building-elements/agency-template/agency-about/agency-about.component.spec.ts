import { AgencyAbout } from './agency-about.component';
...
describe('AgencyAbout', function () {
  let de: DebugElement;
  let comp: AgencyAbout;
  let fixture: ComponentFixture<AgencyAbout>;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     imports:[
            ...
            ReactiveFormsModule,
            HttpModule],
      declarations: [AgencyAbout,ContentEditOptionNav,ViewUploadedImages,Base64UploadComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AgencyAbout);
