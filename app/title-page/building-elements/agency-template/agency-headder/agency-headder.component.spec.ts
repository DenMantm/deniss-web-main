import { AgencyHeadder } from './agency-headder.component';
...
describe('AgencyHeadder', function () {
  let de: DebugElement;
  let comp: AgencyHeadder;
  let fixture: ComponentFixture<AgencyHeadder>;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     imports:[
            ...
            ReactiveFormsModule,
            HttpModule],
      declarations: [AgencyHeadder,ContentEditOptionNav,ViewUploadedImages,Base64UploadComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AgencyHeadder);
