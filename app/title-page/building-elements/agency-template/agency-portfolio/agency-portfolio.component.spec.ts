import { AgencyPortfolio } from './agency-portfolio.component';
...
describe('AgencyPortfolio', function () {
  let de: DebugElement;
  let comp: AgencyPortfolio;
  let fixture: ComponentFixture<AgencyPortfolio>;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     imports:[
            ...
            ReactiveFormsModule,
            HttpModule],
      declarations: [AgencyPortfolio,ContentEditOptionNav,ViewUploadedImages,Base64UploadComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AgencyPortfolio);
