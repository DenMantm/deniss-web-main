import { CreativeHeadder } from './creative-headder.component';
...
describe('CreativeHeadder', function () {
  let de: DebugElement;
  let comp: CreativeHeadder;
  let fixture: ComponentFixture<CreativeHeadder>;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     imports:[
            ...
            ReactiveFormsModule,
            HttpModule],
      declarations: [CreativeHeadder,ContentEditOptionNav,ViewUploadedImages,Base64UploadComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CreativeHeadder);
