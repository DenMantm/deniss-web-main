import { CreativeService } from './creative-service.component';
...
describe('CreativeService', function () {
  let de: DebugElement;
  let comp: CreativeService;
  let fixture: ComponentFixture<CreativeService>;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     imports:[
            ...
            ReactiveFormsModule,
            HttpModule],
      declarations: [CreativeService,ContentEditOptionNav,ViewUploadedImages,Base64UploadComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CreativeService);
